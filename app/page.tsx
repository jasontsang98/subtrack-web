...
import { relativePaymentLabel } from "@/lib/payment-date";
...
const annual=(s:S)=>s.price*cycleAnnual[s.cycle],money=(n:number,d=2)=>n.toLocaleString("en-AU",{style:"currency",currency:"AUD",maximumFractionDigits:d});
const upcoming=(s:S)=>{
