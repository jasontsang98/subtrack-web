...
- `ghcr.io/jasontsang98/subtrack-web:0.3.0`
- `ghcr.io/jasontsang98/subtrack-web-worker:0.3.0`

Set `SUBTRACK_VERSION=0.3.0` in `.env` to pin a release. Pull and start the published images without rebuilding:
...
```sh
gh attestation verify oci://ghcr.io/jasontsang98/subtrack-web:0.3.0 \
